function [bPyr1 bPyr2 bPyr3 bPyr4] = borderPyramid3Tex(csPyrL,csPyrD,cPyr,params)
...
bPrs = params.bPrs;
vmPrs = params.vmPrs;
% vmPrs.R0 = params.tex.MPR0;  %Overwrite Radius of Von Mises
vmPrs.maxLevel = params.tex.maxLevel;   %Overwrite Max Level of Von Mises
texPrs=params.tex;
