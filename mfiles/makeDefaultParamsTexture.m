function params =  makeDefaultParamsTexture
...
maxLevel = 10%10; %How many times do you want to downsample the pyramid

%Set downsampling mode
downSample = 'half'; %downsample by 'half' or 'full' octave. better performance at half

% params.channels = ['IOR']; %feature channels on which to operate
                           %I - intensity
                           %C - color opponency
                           %O - orientation
                           %T - texture
...
params.vmPrs.R0 =R0;
params.vmPrs.tCellSize = 15;

%Grouping Cell inhibition parameters
params.giPrs.w_sameChannel = 1;% Inhibitory weight for same channel inhibition
params.giPrs.tCell = 1/100;

%Texture Parametar
% params.OrientationOppoGauss=20;
params.tex.maxpooling=15;
params.tex.minLevel=1;
params.tex.maxLevel=7;
% params.tex.MPR0=params.tex.maxpooling;%(params.tex.maxpooling+1)/2;
params.tex.shrink=1/(params.tex.maxpooling/2);
